...
def scrape_sim_dining(url):
    """
    scrapes the sim site
    """
    scraped_data = []
    errors = []
    with sync_playwright() as p:
        ...
        try:
            ...
            browser.close()
    with open("./../output/sim_dining_data.json", "w") as f:
...
#     delete_file("./../output/sim_dining_data.json")
#     scrape_sim_dining("https://www.foodadvisor.com.sg/nearby/599491/")
...
def run_scraper(target_url):
    ...
    """
    details_list, errors = scrape_sim_dining(target_url)
    if errors:
