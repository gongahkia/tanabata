...
sites to scrape: https://www.foodadvisor.com.sg/nearby/139651/
...
def scrape_sp_dining(url):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            browser.close()
    with open("./../output/sp_dining_data.json", "w") as f:
...
#     delete_file("./../output/sp_dining_data.json")
#     scrape_sp_dining("https://www.foodadvisor.com.sg/nearby/139651/")
...
def run_scraper(target_url):
    ...
    """
    details_list, errors = scrape_sp_dining(target_url)
    if errors:
