...
sites to scrape: https://www.foodadvisor.com.sg/nearby/189655/
...
def scrape_nafa_dining(url):
    """
    scrapes the nafa site
    """
    scraped_data = []
    errors = []
...
#     delete_file("./../output/nafa_dining_data.json")
#     scrape_nafa_dining("https://www.foodadvisor.com.sg/nearby/189655/")
...
def run_scraper(target_url):
    ...
    """
    details_list, errors = scrape_nafa_dining(target_url)
    if errors:
