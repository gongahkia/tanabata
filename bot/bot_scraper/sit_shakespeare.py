...
def scrape_sit_dining(url):
    """
    scrapes the sit site
    """
    scraped_data = []
    errors = []
    with sync_playwright() as p:
        ...
        try:
            ...
            browser.close()
    with open("./../output/sit_dining_data.json", "w") as f:
...
#     delete_file("./../output/sit_dining_data.json")
#     scrape_sit_dining("https://www.foodadvisor.com.sg/nearby/138683/")
...
def run_scraper(target_url):
    ...
    """
    details_list, errors = scrape_sit_dining(target_url)
    if errors:
