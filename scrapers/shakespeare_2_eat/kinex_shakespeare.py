...
def scrape_kinex_dining(base_url):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for item in items:
                name_element = item.query_selector('div.item-list div.item-text.main-color1 span.item-list-title')
                location_element = item.query_selector('div.item-list div.item-text.main-color1 span:nth-child(2)')
