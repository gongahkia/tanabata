        ...
        try:
            ...
            while True:
                ...
                for item in items:
                    ...
                    raw_name = clean_string(name_element.inner_text()) if name_element else ""
                ...
                next_button = page.query_selector('ul li a.page-link.next') if page.query_selector('ul li a.page-link.next') else None
                print(next_button)
                if next_button:
