...
def scrape_paya_lebar_quarter(base_url):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            while True:
                try:
                    load_more_button = page.query_selector('button.button.button--secondary')
                    if load_more_button:
            ...
            directory_cards = page.query_selector_all('div.directory-card.relative.grid.gap-5.border.px-4.py-5.bg-brand-page')
            for card in directory_cards:
                # print(card.inner_text())
                name_element = card.query_selector('div.relative.flex.flex-col.auto-rows-max.text-brand-body div a')
                ...
                for span in span_elements:
                    ...
                    if span_text.startswith("#"):  
                        ...
                        if span_text == "Food & Restaurant" or span_text == name.strip():
                            pass
                        else:
...
TARGET_URL = "https://www.payalebarquarter.com/directory/mall/?categories=Food+%26+Restaurant"
