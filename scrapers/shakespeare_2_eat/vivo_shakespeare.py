    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            while True:
                ...
                print(f"previous height: {previous_height}\ncurrent height: {new_height}")
            ...
            for item in items:
                ...
                name_element = item.query_selector('div.guideListContentWrapper div.guideListContent a.storeName')
                name = clean_string(name_element.inner_text()) if name_element else ""
                location_element = item.query_selector('div.guideListContentWrapper div.guideListContent div.storeContentSection span.storeTextContent')
                location = clean_string(location_element.inner_text()) if location_element else ""
                category_element = item.query_selector('div.guideListContentWrapper div.guideListContent div.storeContentSectionSecond span.storeTextContent')
