    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for location in locations:
                ...
                location_info = (
                    location_element.inner_text() if location_element else ""
                )
                location_url_info = (
                ...
                description = (
                    location.query_selector("div.location-description").inner_text()
                    if location.query_selector("div.location-description")
                    else ""
                )
