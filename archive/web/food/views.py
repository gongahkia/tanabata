...
from .scrapers.active_scrapers.nus_scraper import fetch_nus_dining_data  # Import the NUS scraper
...
def scrape_food_places(request):
    ...
    print(f"NUS details list has {sum(len(loc) for loc in all_locations.values())} items")
